...
CREATE TABLE `config_link` (
  ...
  PRIMARY KEY (`id`),
  KEY `config_link_owner_id_5d54ab6d_fk_user_userprofile_id` (`owner_id`),
  CONSTRAINT `config_link_owner_id_5d54ab6d_fk_user_userprofile_id` FOREIGN KEY (`owner_id`) REFERENCES `user_userprofile` (`id`)
